...
export type WebSocketServerSyncState = Quality<
  WebSocketServerState,
  WebSocketServerSyncStatePayload
>;
export const webSocketServerSyncState = createQualityCardWithPayload<
  WebSocketServerState,
  WebSocketServerSyncStatePayload
>({
  type: 'Web Socket Server Sync State',
  reducer: (_, action) => {
