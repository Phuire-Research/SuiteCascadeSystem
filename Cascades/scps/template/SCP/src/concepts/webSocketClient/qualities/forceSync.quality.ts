...
import type { ActionStrategy } from 'stratimux';
import { webSocketServerSyncClientState } from '../strategies/server/syncServerState.helper';
import type { WebSocketClientDeck, WebSocketClientState } from '../webSocketClient.concept';
...
export const webSocketClientForceSync = createQualityCardWithPayload<
  ...
  WebSocketClientDeck
>({
  type: 'Web Socket Client Force Sync',
  reducer: nullReducer,
