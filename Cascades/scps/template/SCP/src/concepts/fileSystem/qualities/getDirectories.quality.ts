...
import type { FileSystemGetDirectories } from './types';
...
export const fileSystemGetDirectories: FileSystemGetDirectories = createQualityCardWithPayload<FileSystemState, GetDirectoriesPayload>({
